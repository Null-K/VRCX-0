...
import { GroupProfileRepository } from './groupProfileRepository.js';
...
describe('GroupProfileRepository', () => {
    ...
    it('normalizes group profile fields, counts, roles, and public group URL', () => {
        const repository = new GroupProfileRepository();
    ...
    it('unwraps string error bodies from failed group requests', async () => {
        ...
        await expect(repository.executeGet('groups/grp_123')).rejects.toMatchObject({
            message: 'Forbidden',
            status: 403,
